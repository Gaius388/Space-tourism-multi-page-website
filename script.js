...
// Active Links 
// document.querySelector(`.dots__douglas`)?.classList.add('dots__active'); // Optional Chaining
document.querySelector(`.dots__douglas`) && document.querySelector('.dots__douglas').classList.add('dots__active'); 
...
// document.querySelector(`.tabs__moon`)?.classList.add('active');// Optional Chaining
document.querySelector(`.tabs__moon`) && document.querySelector('.tabs__moon').classList.add('active');
...
// document.querySelector(`.tech__launch`)?.classList.add('technology__active');// Optional Chaining
document.querySelector(`.tech__launch`) && document.querySelector('.tech__launch').classList.add('technology__active');
